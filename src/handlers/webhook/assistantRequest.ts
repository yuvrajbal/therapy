...
export const assistantRequestHandler = async (
   ...
   */
  if (!payload) {
    console.error("No payload provided to assistantRequestHandler");
    throw new Error("No payload provided to assistantRequestHandler");
  }
  console.log("Assistant request received:", payload);
